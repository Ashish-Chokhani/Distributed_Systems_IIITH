...
type LoadBalancerClient interface {
	RegisterServer(ctx context.Context, in *ServerInfo, opts ...grpc.CallOption) (*RegisterResponse, error)
	ReportLoad(ctx context.Context, in *ServerLoad, opts ...grpc.CallOption) (*LoadResponse, error)
	GetBestServer(ctx context.Context, in *BalanceRequest, opts ...grpc.CallOption) (*ServerInfo, error)
}
...
func (c *loadBalancerClient) RegisterServer(ctx context.Context, in *ServerInfo, opts ...grpc.CallOption) (*RegisterResponse, error) {
...
func (c *loadBalancerClient) ReportLoad(ctx context.Context, in *ServerLoad, opts ...grpc.CallOption) (*LoadResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *loadBalancerClient) GetBestServer(ctx context.Context, in *BalanceRequest, opts ...grpc.CallOption) (*ServerInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ServerInfo)
...
type LoadBalancerServer interface {
	RegisterServer(context.Context, *ServerInfo) (*RegisterResponse, error)
	ReportLoad(context.Context, *ServerLoad) (*LoadResponse, error)
	GetBestServer(context.Context, *BalanceRequest) (*ServerInfo, error)
...
func (UnimplementedLoadBalancerServer) RegisterServer(context.Context, *ServerInfo) (*RegisterResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RegisterServer not implemented")
}
func (UnimplementedLoadBalancerServer) ReportLoad(context.Context, *ServerLoad) (*LoadResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReportLoad not implemented")
}
func (UnimplementedLoadBalancerServer) GetBestServer(context.Context, *BalanceRequest) (*ServerInfo, error) {
...
func _LoadBalancer_ReportLoad_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LoadBalancerServer).ReportLoad(ctx, req.(*ServerLoad))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _LoadBalancer_GetBestServer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LoadBalancerServer).GetBestServer(ctx, req.(*BalanceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
